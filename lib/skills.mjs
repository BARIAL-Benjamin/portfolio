    ...
    buildList() {
        ...
        try {
            ...
            this.#skills.forEach(skill => {
                ...
                const title = createTitle(skill.name);
                const desc = createDescription(skill.description);
                const level = createLevel(skill.level);

                li.append(title, desc, level);
